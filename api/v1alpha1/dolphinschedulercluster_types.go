...
type DolphinschedulerClusterSpec struct {
	...
	// Foo is an example field of DolphinschedulerCluster. Edit dolphinschedulercluster_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// DolphinschedulerClusterStatus defines the observed state of DolphinschedulerCluster

...
func NewWorkerLogging(
	...
	mergedCfg *dolphinv1alpha1.WorkerRoleGroupSpec) *resource.LoggingRecociler[*dolphinv1alpha1.DolphinschedulerCluster, any] {
	...
	logDataBuilder := resource.NewGenericRoleLoggingDataBuilder(getRole(), workerLogbackTpl,
...
const workerLogbackTpl = `<?xml version="1.0" encoding="UTF-8"?>
<!--

...
import (
	...
	schedulerv1alpha1 "github.com/zncdata-labs/dolphinscheduler-operator/api/v1alpha1"
...
func ConvertToResourceRequirements(resources *schedulerv1alpha1.ResourcesSpec) *corev1.ResourceRequirements {
	var (
